...
public partial class EditStudent : Window
{
    ...
    private void AddButton_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        string sql = """
                        update Students set Client = @Client,
                        `Group` = @Group
                        where Client = @Client and `Group` = @Group
                     """;
    ...
    private void FillClients()
    {
        ...
        studComboBox.SelectedItem = studComboBox.ItemsSource.Cast<Clients>().First(it => it.Client_name == _stud.Client);
    }
    private void FillGroup()
    {
        ...
        groupComboBox.SelectedItem = groupComboBox.ItemsSource.Cast<Group>().First(it => it.Group_name == _stud.Client);
    }
